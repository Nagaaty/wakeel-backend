...
type Tab = 'about' | 'posts' | 'activity' | 'reviews';
    ...
    <View style={{ flex: 1, backgroundColor: C.bg }}>
      ...
      >
        ...
        <ProfileHeader
          ...
          secondaryActions={[
            {
              label: isRTL ? '⚙️ إعدادات' : '⚙️ Settings',
        ...
        <View style={[styles.tabStrip, { backgroundColor: C.surface, borderBottomColor: C.border }]}>
          <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ paddingHorizontal: 12 }}>
            {(['about', 'posts', 'activity', 'reviews'] as Tab[]).map(t => (
              <TouchableOpacity
                key={t}
                onPress={() => setTab(t)}
...
const styles = StyleSheet.create({
  ...
  tabBtn:   { paddingVertical: 14, paddingHorizontal: 14, borderBottomWidth: 3 },
  section: {
