...
// ─── Smart Fallback Replies (used when AI API is unavailable) ─────────────────
// Keyed by topic id → array of {keywords, ar, en}. The first match wins.
const FALLBACK_REPLIES: Record<string, Array<{kw: string[]; ar: string; en: string}>> = {
  payment: [
    {
      kw: ['charged', 'session didn\'t happen', 'didn\'t happen', 'خُصم', 'لم تكتمل', 'لم تُكتمل'],
      ar: '😔 نعتذر عن هذا الإزعاج!\n\nإذا خُصم المبلغ ولم تُكتمل الجلسة، إليك الخطوات:\n\n1️⃣ تأكد أن الجلسة تظهر في "استشاراتي" بحالة "مكتملة" أم لا.\n2️⃣ إذا لم تكتمل — سيتم رد المبلغ تلقائياً خلال **3-5 أيام عمل**.\n3️⃣ إذا مرّ أكثر من 5 أيام — تواصل مع وكيل بشري الآن.\n\nهل ساعدك ذلك؟',
      en: '😔 Sorry for the inconvenience!\n\nIf you were charged but the session didn\'t happen:\n\n1️⃣ Check "My Consultations" to confirm the session status.\n2️⃣ If it shows incomplete — a **full refund is issued automatically within 3-5 business days**.\n3️⃣ If 5+ days have passed — please escalate to a human agent below.\n\nDid this help?',
    },
    {
      kw: ['refund', 'استرداد', 'أموالي', 'استرجاع'],
      ar: '💰 لطلب استرداد الأموال:\n\n1️⃣ اذهب إلى **استشاراتي** ← اختر الجلسة\n2️⃣ اضغط **"طلب استرداد"** إذا كانت الجلسة لم تكتمل\n3️⃣ سيتم مراجعة الطلب خلال **24-48 ساعة**\n4️⃣ سيُعاد المبلغ لوسيلة الدفع الأصلية خلال **3-5 أيام عمل**\n\nإذا لم يظهر زر الاسترداد — تواصل مع وكيل بشري أدناه.\n\nهل ساعدك ذلك؟',
      en: '💰 To request a refund:\n\n1️⃣ Go to **My Consultations** → select the session\n2️⃣ Tap **"Request Refund"** if the session was incomplete\n3️⃣ Our team reviews it within **24-48 hours**\n4️⃣ Money returns to your original payment method in **3-5 business days**\n\nIf you don\'t see the refund button — talk to a human agent below.\n\nDid this help?',
    },
    {
      kw: ['failed', 'فشل', 'لم يتم'],
      ar: '❌ إذا فشل الدفع:\n\n1️⃣ تأكد من صحة بيانات البطاقة\n2️⃣ تأكد أن رصيد البطاقة كافٍ\n3️⃣ جرّب بطاقة أخرى أو وسيلة دفع مختلفة\n4️⃣ إذا استمرت المشكلة — أوقف وأعد تشغيل التطبيق وحاول مجدداً\n\nإذا تكررت المشكلة، تواصل مع وكيل أدناه.\n\nهل ساعدك ذلك؟',
      en: '❌ If your payment failed:\n\n1️⃣ Double-check your card details\n2️⃣ Make sure you have sufficient balance\n3️⃣ Try a different card or payment method\n4️⃣ If it persists — restart the app and try again\n\nStill failing? Talk to an agent below.\n\nDid this help?',
    },
    {
      kw: ['wrong amount', 'رسوم غير صحيحة', 'مبلغ خاطئ'],
      ar: '🔍 إذا خُصم مبلغ خاطئ:\n\n1️⃣ راجع تفاصيل الجلسة في **"استشاراتي"** للتأكد من السعر المتفق عليه\n2️⃣ قارن مع سعر المحامي في صفحة ملفه الشخصي\n3️⃣ إذا وجدت اختلافاً — أرسل لقطة شاشة لوكيل بشري أدناه\n\nهل ساعدك ذلك؟',
      en: '🔍 If you were charged the wrong amount:\n\n1️⃣ Check the session details in **My Consultations** to confirm the agreed price\n2️⃣ Compare with the lawyer\'s listed rate on their profile\n3️⃣ If there\'s a discrepancy — share a screenshot with a human agent below\n\nDid this help?',
    },
  ],
  booking: [
    {
      kw: ['cancelled', 'ألغيت', 'إلغاء'],
      ar: '📅 إذا أُلغي موعدك:\n\n1️⃣ تحقق من إشعاراتك لمعرفة سبب الإلغاء\n2️⃣ إذا أُلغي من المحامي — يحق لك **استرداد كامل المبلغ** تلقائياً\n3️⃣ يمكنك حجز جلسة جديدة مع نفس المحامي أو اختيار آخر\n4️⃣ لمراجعة الموعد: **استشاراتي** ← اختر الجلسة\n\nهل ساعدك ذلك؟',
      en: '📅 If your booking was cancelled:\n\n1️⃣ Check your notifications for the cancellation reason\n2️⃣ If cancelled by the lawyer — you get an **automatic full refund**\n3️⃣ You can rebook with the same lawyer or choose another\n4️⃣ To review: **My Consultations** → select the session\n\nDid this help?',
    },
    {
      kw: ['didn\'t show', 'لم يحضر', 'لم يأت'],
      ar: '⚠️ إذا لم يحضر المحامي:\n\n1️⃣ انتظر **10 دقائق** — قد يكون هناك تأخير\n2️⃣ جرّب التواصل معه عبر رسائل التطبيق\n3️⃣ إذا لم يحضر — أبلغ عن الجلسة من **استشاراتي** للحصول على استرداد كامل\n4️⃣ سنحجب المحامي مؤقتاً لحين التحقيق\n\nهل ساعدك ذلك؟',
      en: '⚠️ If the lawyer didn\'t show up:\n\n1️⃣ Wait **10 minutes** — there may be a delay\n2️⃣ Try messaging them through the app\n3️⃣ If they still don\'t appear — report the session from **My Consultations** for a full refund\n4️⃣ The lawyer will be temporarily suspended pending investigation\n\nDid this help?',
    },
    {
      kw: ['reschedule', 'تغيير', 'تأجيل'],
      ar: '🔄 لتغيير موعد الجلسة:\n\n1️⃣ اذهب إلى **استشاراتي**\n2️⃣ اختر الجلسة واضغط **"إعادة جدولة"**\n3️⃣ اختر الوقت الجديد المناسب\n4️⃣ يجب إعادة الجدولة قبل **ساعتين على الأقل** من الموعد\n\nهل ساعدك ذلك؟',
      en: '🔄 To reschedule your session:\n\n1️⃣ Go to **My Consultations**\n2️⃣ Select the session and tap **"Reschedule"**\n3️⃣ Pick a new available time slot\n4️⃣ Must be done at least **2 hours before** the session\n\nDid this help?',
    },
    {
      kw: ['confirmation', 'تأكيد', 'لم أتلق'],
      ar: '📩 لم تتلق تأكيداً؟\n\n1️⃣ تحقق من مجلد **البريد العشوائي (Spam)**\n2️⃣ تأكد أن بريدك الإلكتروني محدّث في إعدادات الحساب\n3️⃣ يمكنك رؤية تفاصيل الحجز مباشرة في **استشاراتي**\n4️⃣ إذا لم يظهر الحجز أصلاً — تواصل مع وكيل بشري\n\nهل ساعدك ذلك؟',
      en: '📩 Didn\'t receive a confirmation?\n\n1️⃣ Check your **spam/junk folder**\n2️⃣ Verify your email is correct in account settings\n3️⃣ You can view booking details directly in **My Consultations**\n4️⃣ If the booking doesn\'t appear at all — talk to a human agent\n\nDid this help?',
    },
  ],
  lawyer: [
    {
      kw: ['respond', 'لم يرد', 'لا يرد'],
      ar: '⏱️ إذا لم يرد المحامي:\n\n1️⃣ المحامون ملتزمون بالرد خلال **24 ساعة** من الحجز\n2️⃣ جرّب إرسال رسالة عبر المحادثة في التطبيق\n3️⃣ إذا لم يرد بعد 24 ساعة — اضغط **"الإبلاغ"** في صفحة الجلسة\n4️⃣ سنتواصل مع المحامي فوراً وقد نلغي حجزك مع استرداد كامل\n\nهل ساعدك ذلك؟',
      en: '⏱️ If the lawyer isn\'t responding:\n\n1️⃣ Lawyers are required to respond within **24 hours** of booking\n2️⃣ Try sending a message through the in-app chat\n3️⃣ After 24 hours with no response — tap **"Report"** on the session page\n4️⃣ We\'ll contact the lawyer immediately and may cancel your booking with a full refund\n\nDid this help?',
    },
    {
      kw: ['unprofessional', 'غير مهني', 'سلوك'],
      ar: '🚨 للإبلاغ عن سلوك غير مهني:\n\n1️⃣ اذهب إلى **استشاراتي** ← اختر الجلسة\n2️⃣ اضغط **"تقييم الجلسة"** أو **"الإبلاغ عن مشكلة"**\n3️⃣ اختر نوع المشكلة وأضف وصفاً\n4️⃣ ستُراجَع الشكوى خلال **48 ساعة** وستتلقى رداً\n\nيمكنك أيضاً التحدث مع وكيل بشري أدناه لتسريع العملية.\n\nهل ساعدك ذلك؟',
      en: '🚨 To report unprofessional behavior:\n\n1️⃣ Go to **My Consultations** → select the session\n2️⃣ Tap **"Rate Session"** or **"Report an Issue"**\n3️⃣ Select the issue type and add a description\n4️⃣ Your complaint will be reviewed within **48 hours**\n\nYou can also talk to a human agent below to expedite.\n\nDid this help?',
    },
  ],
  app: [
    {
      kw: ['log in', 'login', 'sign in', 'تسجيل الدخول', 'لا أستطيع'],
      ar: '🔐 مشكلة في تسجيل الدخول؟\n\n1️⃣ تأكد من صحة البريد الإلكتروني وكلمة المرور\n2️⃣ جرّب **"نسيت كلمة المرور"** لإعادة تعيينها\n3️⃣ أغلق التطبيق تماماً وأعد فتحه\n4️⃣ إذا استمرت المشكلة — امسح ذاكرة التخزين المؤقت من إعدادات هاتفك\n\nهل ساعدك ذلك؟',
      en: '🔐 Can\'t log in?\n\n1️⃣ Double-check your email and password\n2️⃣ Try **"Forgot Password"** to reset it via email\n3️⃣ Force-close the app and reopen it\n4️⃣ If it persists — clear the app cache from your phone settings\n\nDid this help?',
    },
    {
      kw: ['slow', 'بطيء', 'يتجمد', 'freeze'],
      ar: '🐢 التطبيق بطيء أو يتجمد؟\n\n1️⃣ تأكد من اتصالك بالإنترنت\n2️⃣ أغلق التطبيق وأعد فتحه\n3️⃣ أعد تشغيل هاتفك\n4️⃣ تأكد أن لديك **آخر إصدار** من التطبيق\n5️⃣ احذف التطبيق وأعد تثبيته\n\nهل ساعدك ذلك؟',
      en: '🐢 App slow or freezing?\n\n1️⃣ Check your internet connection\n2️⃣ Force-close the app and reopen\n3️⃣ Restart your phone\n4️⃣ Make sure you have the **latest version** installed\n5️⃣ Uninstall and reinstall the app\n\nDid this help?',
    },
  ],
  account: [
    {
      kw: ['password', 'كلمة المرور', 'نسيت'],
      ar: '🔑 لإعادة تعيين كلمة المرور:\n\n1️⃣ اضغط **"نسيت كلمة المرور"** في شاشة تسجيل الدخول\n2️⃣ أدخل بريدك الإلكتروني المسجّل\n3️⃣ ستصلك رسالة بها رابط إعادة التعيين\n4️⃣ الرابط صالح لمدة **10 دقائق** فقط\n5️⃣ تحقق من مجلد الرسائل غير المرغوب فيها إذا لم تجد الرسالة\n\nهل ساعدك ذلك؟',
      en: '🔑 To reset your password:\n\n1️⃣ Tap **"Forgot Password"** on the login screen\n2️⃣ Enter your registered email address\n3️⃣ You\'ll receive a reset link by email\n4️⃣ The link is valid for **10 minutes** only\n5️⃣ Check spam/junk if you don\'t see it\n\nDid this help?',
    },
    {
      kw: ['suspended', 'banned', 'محظور', 'موقوف'],
      ar: '⚠️ إذا كان حسابك محظوراً:\n\n1️⃣ غالباً يكون الحظر بسبب انتهاك شروط الاستخدام\n2️⃣ ستصلك رسالة بريد إلكتروني تشرح السبب\n3️⃣ يمكنك الاعتراض عبر التواصل مع وكيل بشري أدناه\n4️⃣ سيتم مراجعة حالتك خلال **24-48 ساعة**\n\nهل ساعدك ذلك؟',
      en: '⚠️ If your account is suspended:\n\n1️⃣ Suspensions are usually due to a terms of service violation\n2️⃣ You should have received an email explaining the reason\n3️⃣ You can appeal by talking to a human agent below\n4️⃣ Your case will be reviewed within **24-48 hours**\n\nDid this help?',
    },
  ],
};

function getFallbackReply(topicId: string, userText: string, isRTL: boolean): string | null {
  const replies = FALLBACK_REPLIES[topicId];
  if (!replies) return null;
  const lower = userText.toLowerCase();
  const match = replies.find(r => r.kw.some(k => lower.includes(k.toLowerCase())));
  if (match) return isRTL ? match.ar : match.en;
  // Return the first reply as generic fallback for this topic
  return isRTL ? replies[0].ar : replies[0].en;
}
...
function SmartChat({ C, isRTL, topic, user, onEscalate }: any) {
  ...
  const sendMessage = useCallback(async (text: string) => {
    ...
    try {
      // ── STRICT WAKEEL SUPPORT PROMPT ─────────────────────────────────────────
      // Rules:
      //  1. Answer ONLY Wakeel platform questions (bookings, payments, account, app)
      //  2. If user asks ANY legal question → politely refuse + refer to lawyers
      //  3. Always reply in Arabic (or match user language)
      const systemPrompt = isRTL
        ? `أنت مساعد خدمة عملاء لمنصة "وكيل" المتخصصة في الخدمات القانونية في مصر.

مهمتك الوحيدة هي مساعدة المستخدمين في:
- مشاكل الحجز والمواعيد
- مشاكل الدفع والاسترداد
- الشكاوى على المحامين
- مشاكل الحساب أو التطبيق
- الأسئلة العامة عن المنصة

السياق الحالي: ${topic.prompt}

قواعد صارمة:
1. إذا سألك المستخدم أي سؤال قانوني (حتى لو بدا بسيطاً) — لا تجب عليه إطلاقاً.
   قل تحديداً: "هذا سؤال قانوني 👨‍⚖️ ولا يمكنني الإجابة عليه — لكن لديك محامون متخصصون على المنصة يمكنهم مساعدتك. اضغط 'ابحث عن محامٍ' أدناه."
2. لا تقدم أي استشارة قانونية أو تفسير للقانون.
3. أجب بالعربية دائماً بأسلوب ودود ومختصر.
4. أنهِ ردك بـ: "هل ساعدك ذلك؟"`
        : `You are a customer service assistant for "Wakeel", an Egyptian legal services platform.
...
Current context: ${topic.prompt}

STRICT RULES:
1. If the user asks ANY legal question (even a simple one) — do NOT answer it.
   Say exactly: "That's a legal question ⚖️ and I'm not qualified to answer it — but we have specialized lawyers on the platform who can help you. Tap 'Find a Lawyer' below."
2. Never give legal advice, legal interpretations, or answer questions about laws, rights, contracts, or legal procedures.
3. Reply in a friendly, concise, and actionable tone.
4. End your reply with: "Did this help?"`;
      ...
      // Detect if AI refused a legal question → show "Find a Lawyer" action button
      const isLegalRefusal = reply.includes('👨‍⚖️') || reply.includes('⚖️') ||
        reply.toLowerCase().includes('find a lawyer') ||
        reply.includes('محامٍ') || reply.includes('محامين');

      const assistantMsg: Msg = {
        role: 'assistant',
        content: reply || (isRTL ? 'عذراً، لم أفهم استفسارك.' : 'Sorry, I didn\'t quite catch that.'),
        chips: [],
        resolved: !isLegalRefusal, // Don't show thumbs on legal refusal — show action instead
        ts: ts(),
        ...(isLegalRefusal ? {
          action: {
            label: isRTL ? '🔍 ابحث عن محامٍ' : '🔍 Find a Lawyer',
      ...
      // AI unavailable — use smart scripted fallback instead of error message
      const fallback = getFallbackReply(topic.id, q, isRTL);
      setMessages(p => [...p, {
        role: 'assistant',
        content: fallback || (isRTL
          ? '⚠️ المساعد الذكي غير متاح حالياً. يمكنك التحدث مع وكيل بشري أدناه أو المحاولة مرة أخرى.'
          : '⚠️ AI assistant is temporarily unavailable. Please talk to a human agent below or try again.'),
        resolved: !!fallback,
        ts: ts(),
      }]);
    } finally {
