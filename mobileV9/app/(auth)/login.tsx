...
import { login, fetchMe, selLoading, selError, clearError } from '../../src/features/auth/authSlice';
...
export default function LoginScreen() {
  ...
  const handleLogin = async () => {
    ...
    dispatch(clearError());
    const res = await dispatch(login({ email: email.toLowerCase().trim(), password, role }));
